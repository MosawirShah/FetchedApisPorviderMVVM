...
class _SignUpViewState extends State<SignUpView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: "SignUp User",context: context,flag: false,),
      body: SafeArea(
        child: SizedBox(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //Button
                RoundButton(title: "SignUp User",loading: authProvider.loading, onTapButton: (){
                  if(_emailController.text.isEmpty){
                    ...
                    authProvider.signUpUserApi(data: data).then((value){
                      final userPreferences = Provider.of<UserViewModel>(context,listen: false);
                      userPreferences.saveUser(UserModel.fromJson(value));
                      AppUtils.toastMessage('SignUp successfully');
